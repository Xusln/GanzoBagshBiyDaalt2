...
SECRET_KEY = 'django-insecure-b&cjy3hphj_56r!%tm_31yu$to)4s)h&&hjq1tew2+*uahxcox'
...
ROOT_URLCONF = 'ZahiiBackEnd.urls'
...
WSGI_APPLICATION = 'ZahiiBackEnd.wsgi.application'
